 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://soap.com/", wsdlLocation = "http://localhost:8081/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://soap.com/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/PersonService?wsdl");
